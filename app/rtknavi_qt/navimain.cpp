...
void  MainWindow::LoadOpt(void)
{
    ...
    PrcOpt.thresar[0]=settings.value("prcopt/thresar",          prcopt.thresar).toDouble();
    ...
    ExSats          =settings.value("prcopt/exsats",            prcopt.exsats).toString();
    ...
    SolOpt.sep     =settings.value("solopt/sep",                solopt.sep).toString();
